...
%JAVACMD% %JAVA_OPTS% %EXTRA_JVM_ARGUMENTS% -classpath %CLASSPATH_PREFIX%;%CLASSPATH% -Dapp.name="foprep" -Dapp.repo="%REPO%" -Dbasedir="%BASEDIR%" net.sourceforge.jeuclid.app.foprep.Main %CMD_LINE_ARGS%
